...
class FallbackSentimentGenerator:
...
if __name__ == "__main__":
    ...
    intent_names = [
        # "topic-hometown-what-answer",
        # "topic-hometown-big-city",
        # "topic-hometown-unknown-city-size",
        "topic-travel-homecountry-human-seen-the-northern-lights",
    ]
    ...
    gen = FallbackSentimentGenerator(config)
    gen.run()
